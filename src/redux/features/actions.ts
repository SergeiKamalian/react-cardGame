...
import { SET_BITO_CARDS, SET_COMPUTER_CARDS, SET_GAME_TRUMP, SET_USER_CARDS, SET_GAME_STARTER, SET_INTABLE_CARDS, SET_GAME_WIN } from "./game/gameTypes";
...
export const setClickedCard = (card: ICard | null) => ({
	type: SET_CLICKD_CARD,
	payload: card
})
export const setUserClickedCard = (card: ICard | null) => ({
	type: SET_CLICKED_USER_CARD,
	payload: card
})
export const setGameWin = (winner: string | null) => ({
	type: SET_GAME_WIN,
	payload: winner
})